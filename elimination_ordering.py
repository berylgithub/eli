            ...
            for i in range(n_init):
                ...
                if valency == n-1:
                    ...
                    if bool_subset:
                        ...
                        self.deleted[i] = True
                        modified[neighbours] = 1
                        print("rule 6, merged",i ,"to",j_node)
